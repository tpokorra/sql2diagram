/* ***********************************************************************
 *
 * filename:            $Source: /cvsroot/sql2diagram/sql2diagram/Attic/dia.h,v $
...
public:
	...
	void outDia(FILE* file, string module, DataBase& db, bool repeatedRun);
	bool outDiaConstraints(FILE* file, DataBase& db);
...
public:
	...
	void outDia(FILE* file, bool printConstraints);
